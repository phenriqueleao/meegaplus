        ...
        <div class="card-header"> {{ isset($url) ? ucwords($url) : ""}} {{ __('Register') }}</div>
          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
              ...
              @if ($url == 'student')
              <div class="form-group row">
                <label for="evaluation_id" class="col-md-4 col-form-label text-md-right">{{ __('Avaliação') }}</label>

                <div class="col-md-6">
                  <select name="evaluation_id" id="evaluation" class="form-control @error('evaluation') is-invalid @enderror" name="evaluation" value="{{ old('evaluation') }}" required autocomplete="evaluation" autofocus>
